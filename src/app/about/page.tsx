            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm font-sans">Owner &amp; Founder, Acadia Pools</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-3">
                  <svg className="w-8 h-8 text-gold" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
